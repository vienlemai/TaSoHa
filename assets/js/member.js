		...
		'core': {
			...
			'data': {
				'url': function(node) {
					...
					return node.id === '#' ? baseUrl + '/member/tree-binary/children/' + currentMemberId : baseUrl + '/member/tree-binary/children/' + node.id;
				},
				'data': function(node) {
					return {'id': node.id};
				}
	...
	$('#member-tree-sun').jstree({
		'core': {
			...
			'data': {
				'url': function(node) {
					var currentMemberId = $('#current-member-id').val();
					return node.id === '#' ? baseUrl + '/member/tree-sun/children/' + currentMemberId : baseUrl + '/member/tree-sun/children/' + node.id;
				},
				'data': function(node) {
					return {'id': node.id};
				}
